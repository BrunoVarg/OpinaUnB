...
from opinaunb.polls.cruds.avaliacao_professor import create_avaliacao_professor, get_nota
...
#create_avaliacao_professor(con, "Algum comentário", 123456, 1, 6)
#create_avaliacao_professor(con, "Algum comentário", 11111, 1, 8)
#create_avaliacao_professor(con, "Algum comentário", 123456, 1, 6)

print(get_nota(con, 1))
